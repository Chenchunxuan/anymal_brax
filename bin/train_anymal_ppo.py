...
def load_config() -> dict:
  config = {
    "result_indentifier": 'anymal_c', # no need for underscore
    "env_name": 'anymal_c',  # @param ['anymal_c', 'a1', 'ant', 'halfcheetah', 'hopper', 'humanoid', 'humanoidstandup', 'inverted_pendulum', 'inverted_double_pendulum', 'pusher', 'reacher', 'walker2d']
